    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center gap-1 text-sm text-[var(--yellow)] hover:text-[var(--color2)]"
        >
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <div>
          <label className="block text-sm text-[var(--yellow)] mb-1">Category</label>
          <select
            value={category}
            onChange={(e) => setCategory(e.target.value)}
            className=" rounded-lg border border-[var(--yellow)] px-3 py-2 w-full focus:ring-2 focus:ring-[var(--yellow)]"
          >
            {categories.map((c) => (
        ...
        <div>
          <label className="block text-sm text-[var(--yellow)] mb-1">
